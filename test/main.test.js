...
describe("Json class all controls", () => {
    it("databaseName with process.cwd()", () => {
        console.log(
            new JsonDatabase(
                {
                    databasePath: `${process.cwd()}/databases/example1/example1.json`
                }
            ).path
        );
    });
    ...
    it("databaseName with './'", () => {
        console.log(
            new JsonDatabase(
                {
                    databasePath: "./databases/example2/example2.json"
                }
            ).path
        );
    });
    ...
    it("databaseName with process.cwd() and ./", () => {
        console.log(
            new JsonDatabase(
                {
                    databasePath: `${process.cwd()}./databases/example4/example4.json`
                }
            ).path
        );
    });
